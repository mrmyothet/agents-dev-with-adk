...
## Agent System Development with ADK Framework

### 1. **ADK_Learning_tools.ipynb** 🛠️

A foundational notebook covering custom tools and conversational memory:

- **Build Foundational Agents**: Create simple yet effective AI agents from scratch using ADK
- **Grant New Skills with Custom Tools**: Connect agents to external APIs (e.g., weather services)
...
- **SequentialAgent**: Chain agents together to create pipelines where one agent's output feeds into the next
...
- Install the necessary libraries: `google-adk` and `google-generativeai`
- Obtain your Google API key from: https://codelabs.developers.google.com/onramp/instructions
